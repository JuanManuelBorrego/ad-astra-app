...
def aplicar_interfaz_cientifica():
    ...
    st.markdown('<div>© 2026 - Proyecto <b>Ad Astra</b> | Prof. Juan Manuel Borrego<br><b>Centro de Navegación de Datos & Didáctica Matemática</b></div>', unsafe_allow_html=True)
# --- LLAMADA INICIAL ---
